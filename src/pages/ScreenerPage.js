...
const SourceBadge = styled.span`
    ...
    background: ${props => {
        if (props.$source === 'geckoterminal') return '#f0b90b33';
        return props.theme?.brand?.primary + '33' || '#00adef33';
    }};
    color: ${props => {
        if (props.$source === 'geckoterminal') return '#f0b90b';
        return props.theme?.brand?.primary || '#00adef';
    }};
    border: 1px solid ${props => {
        if (props.$source === 'geckoterminal') return '#f0b90b66';
                                        ...
                                        <Name theme={theme}>
                                            ...
                                            {mode === 'crypto' && item.source && (
                                                <SourceBadge theme={theme} $source={item.source}>
                                                    {item.source === 'geckoterminal' ? '📊 GT' : '🦎 CG'}
                                                </SourceBadge>
                                            )}
                                        </Name>
                                    </TableCell>
