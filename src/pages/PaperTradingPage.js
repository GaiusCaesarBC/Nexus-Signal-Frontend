                                        ...
                                        <PositionCard theme={theme} key={positionKey} $positive={position.profitLoss >= 0} $positionType={position.positionType} onClick={() => togglePositionExpand(positionKey)}>
                                            ...
                                            <ExpandedDetails $expanded={isExpanded}>
                                                <ExpandedContent theme={theme}>
                                                    <ExpandedGrid>
                                                        <ExpandedItem theme={theme}><ExpandedLabel theme={theme}>{isLeveraged ? 'Position Value' : 'Total Value'}</ExpandedLabel><ExpandedValue theme={theme} $color={theme?.brand?.primary || '#00adef'}>{formatCurrency(isLeveraged ? position.leveragedValue : totalValue)}</ExpandedValue></ExpandedItem>
                                                        <ExpandedItem theme={theme}><ExpandedLabel theme={theme}>{isLeveraged ? 'Margin Used' : 'Cost Basis'}</ExpandedLabel><ExpandedValue theme={theme}>{formatCurrency(costBasis)}</ExpandedValue></ExpandedItem>
